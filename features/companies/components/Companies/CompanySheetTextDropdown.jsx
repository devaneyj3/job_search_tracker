...
import styles from '@/styles/CompanySheetTextDropdown.module.scss'

export default function CompanySheetTextDropdown({ item, label, field, activeSection, toggleSection, index }) {
  return (
      <section
